...
public class AirportTest {
    ...
    public void testGetTransportMilitaryPlanes() {
        List<MilitaryPlane> transportMilitaryPlanes = airport.getMilitaryPlanesWithType(MilitaryType.TRANSPORT);
        boolean flag = true;
    ...
    public void testHasAtLeastOneBomberInMilitaryPlanes() {
        List<MilitaryPlane> bomberMilitaryPlanes = airport.getMilitaryPlanesWithType(MilitaryType.BOMBER);
        boolean flag = false;
